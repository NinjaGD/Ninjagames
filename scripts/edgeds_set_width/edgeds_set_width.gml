/// @description edgeds_set_width(dpi mode, dpi override, width, minheight, zoom);
...
if global.display_xscale != global.display_xprevscale or global.display_yscale != global.display_yprevscale or global.display_zoom != argument4 {
   ...
   //Scale the view
   __view_set( e__VW.WView, global.display_view, (argument2*dpi)/global.display_zoom );
   __view_set( e__VW.HView, global.display_view, (display_height*dpi)/global.display_zoom );
   ...
   //All platforms
   surface_resize(application_surface, min(window_width, argument2), min(window_height, display_height));
